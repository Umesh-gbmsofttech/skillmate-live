...
public class Student {
    ...
    @ManyToMany
    @JoinTable(name = "student_trainers", joinColumns = @JoinColumn(name = "student_id"), inverseJoinColumns = @JoinColumn(name = "trainer_id"))
    // @JsonView(JsonResoponse_View.BasicView.class)
    // @JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class,
    // property = "id")
...
// @OneToMany(mappedBy = "toStudent", cascade = {CascadeType.ALL}, fetch =
// FetchType.LAZY)
// // @JsonView(JsonResoponse_View.BasicView.class)
// private List<RatingReviews> ratingReviews = new ArrayList<>();
