...
public class RatingReviewsController {
    ...
    // Get list of ratings of a single Course
    ...
    // Get list of ratings of a single Trainer
    @GetMapping("/trainer/{trainerId}")
    @JsonView(JsonResoponse_View.BasicView.class)
    public ResponseEntity<List<RatingReviews>> getTrainerRatings(@PathVariable Long trainerId) {
        return ResponseEntity.ok(ratingReviewService.getReviewsForTrainer(trainerId));
    }

    // Get list of ratings of a single Student
    @GetMapping("/student/{studentId}")
    @JsonView(JsonResoponse_View.BasicView.class)
    public ResponseEntity<List<RatingReviews>> getStudentRatings(@PathVariable Long studentId) {
        return ResponseEntity.ok(ratingReviewService.getReviewsForStudent(studentId));
    }

    // to get all rating and reviews`
    @GetMapping("/fetch")
    @JsonView(JsonResoponse_View.DetailedView.class)
...
// Logger.getLogger(RatingReviewsController.class.getName());
//
// @Autowired
// private RatingReviewService ratingReviewService;
//
...
// @GetMapping("/course/{courseId}")
// @JsonView(JsonResoponse_View.BasicView.class)
// public ResponseEntity<List<RatingReviews>> getCourseRatings(@PathVariable
// Long courseId) {
// try {
// List<RatingReviews> reviews =
// ratingReviewService.getReviewsForCourse(courseId);
// return ResponseEntity.ok(reviews);
// } catch (Exception e) {
...
// @GetMapping("/trainer/{trainerId}")
// @JsonView(JsonResoponse_View.BasicView.class)
// public ResponseEntity<List<RatingReviews>> getTrainerRatings(@PathVariable
// Long trainerId) {
// try {
// List<RatingReviews> reviews =
// ratingReviewService.getReviewsForTrainer(trainerId);
// return ResponseEntity.ok(reviews);
// } catch (Exception e) {
// return ResponseEntity.status(500).body(null); // Handle errors
// }
...
// @GetMapping("/student/{studentId}")
// @JsonView(JsonResoponse_View.BasicView.class)
// public ResponseEntity<List<RatingReviews>> getStudentRatings(@PathVariable
// Long studentId) {
// try {
// List<RatingReviews> reviews =
// ratingReviewService.getReviewsForStudent(studentId);
// return ResponseEntity.ok(reviews);
// } catch (Exception e) {
// return ResponseEntity.status(500).body(null); // Handle errors
// }
...
// public ResponseEntity<RatingReviews> createCourseRating(@PathVariable Long
// courseId, @RequestBody RatingReviews ratingReview) {
// try {
// RatingReviews createdReview =
// ratingReviewService.createCourseRating(courseId, ratingReview);
...
// public ResponseEntity<RatingReviews> createTrainerRating(@PathVariable Long
// trainerId, @RequestBody RatingReviews ratingReview) {
// try {
// RatingReviews createdReview =
// ratingReviewService.createTrainerRating(trainerId, ratingReview);
// return ResponseEntity.status(201).body(createdReview);
// } catch (Exception e) {
// return ResponseEntity.status(500).body(null); // Handle errors
// }
...
// public ResponseEntity<RatingReviews> createStudentRating(@PathVariable Long
// studentId, @RequestBody RatingReviews ratingReview) {
// try {
// RatingReviews createdReview =
// ratingReviewService.createStudentRating(studentId, ratingReview);
// return ResponseEntity.status(201).body(createdReview);
// } catch (Exception e) {
// return ResponseEntity.status(500).body(null); // Handle errors
// }
...
// try {
// RatingReviews createdReview =
// ratingReviewService.createAdminReview(reviewText, courseId, trainerId,
// studentId);
// return ResponseEntity.status(HttpStatus.CREATED).body(createdReview);
// } catch (EntityNotFoundException e) {
// logger.severe("Error creating admin review: " + e.getMessage());
...
// public List<RatingReviews> getReviewsByTrainer(@RequestParam boolean
// isGivenToTrainer) {
...
// public List<RatingReviews> getReviewsByStudent(@RequestParam boolean
// isGivenToStudent) {
...
// public List<RatingReviews> getReviewsByCourse(@RequestParam boolean
// isGivenToCourse) {
...
//// @GetMapping("/admin")
//// public List<RatingReviews> getReviewsByAdmin(@RequestParam boolean
// isGivenByAdmin) {
//// return ratingReviewService.getReviewsByAdmin(isGivenByAdmin);
//// }
//
// // Endpoint to get reviews where 'isGivenToTrainer' is true and filter by
// trainerId
// @GetMapping("/given-to/trainer/{trainerId}")
// public List<RatingReviews> getReviewsByTrainerAndId(@RequestParam boolean
// isGivenToTrainer, @PathVariable Long trainerId) {
// return ratingReviewService.getReviewsByTrainerAndId(isGivenToTrainer,
// trainerId);
// }
//
// // Endpoint to get reviews where 'isGivenToStudent' is true and filter by
// studentId
// @GetMapping("/given-to/student/{studentId}")
// public List<RatingReviews> getReviewsByStudentAndId(@RequestParam boolean
// isGivenToStudent, @PathVariable Long studentId) {
// return ratingReviewService.getReviewsByStudentAndId(isGivenToStudent,
// studentId);
// }
//
// // Endpoint to get reviews where 'isGivenToCourse' is true and filter by
// courseId
// @GetMapping("/given-to/course/{courseId}")
// public List<RatingReviews> getReviewsByCourseAndId(@RequestParam boolean
// isGivenToCourse, @PathVariable Long courseId) {
// return ratingReviewService.getReviewsByCourseAndId(isGivenToCourse,
// courseId);
// }
// }
