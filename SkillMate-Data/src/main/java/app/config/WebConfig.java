...
public class WebConfig {
	...
	public CorsFilter corsFilter() {
		...
		config.addAllowedOrigin("https://989rdskd-5173.inc1.devtunnels.ms"); // Allow your frontend's origin
	...
	public WebMvcConfigurer corsConfigurer() {
		return new WebMvcConfigurer() {
			...
			public void addCorsMappings(CorsRegistry registry) {
				registry.addMapping("/**")
						.allowedOrigins("https://989rdskd-5173.inc1.devtunnels.ms", "http://localhost:5173",
