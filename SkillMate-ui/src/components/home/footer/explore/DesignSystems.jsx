...
function DesignSystems() {
    ...
    const handleApplyNowClick = () => {
        showSuccessToast('Applying for Design Systems position');
    };
    const handleExploreDesignSystemsOpportunitiesClick = () => {
        showSuccessToast('Explore Design Systems Opportunities');
    };
    ...
    return (
        ...
        >
            ...
            <Box sx={ { textAlign: 'center', marginTop: 6 } }>
                <CustomButton onClick={ handleExploreDesignSystemsOpportunitiesClick } text={ 'Explore Design Systems Opportunities' } />
            </Box>
        </Box>
    );
}
