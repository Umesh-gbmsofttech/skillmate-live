...
function UiUxDesign() {
    ...
    const handleApplyNowClick = () => {
        showSuccessToast('Applying for UI/UX Designer position');
    };
    const learnMoreVisualDesignClick = () => {
        showSuccessToast('Learn more about Visual and Interactive Designs');
    };
    const learnMorePrototypingTestingClick = () => {
        showSuccessToast('Learn more about Prototyping and user Testing');
    };

    const handleExploreOpportunitiesClick = () => {
        showSuccessToast('Explore UI/UX Design Opportunities');
    };
    ...
    return (
        ...
        >
                ...
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ learnMoreVisualDesignClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ learnMorePrototypingTestingClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
            ...
            <Box sx={ { textAlign: 'center', marginTop: 6 } }>
                <CustomButton onClick={ handleExploreOpportunitiesClick } text={ 'Explore UI/UX Design Opportunities' } />
            </Box>
        </Box>
    );
}
