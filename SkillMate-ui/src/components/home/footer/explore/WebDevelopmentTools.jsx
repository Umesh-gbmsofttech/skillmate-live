...
function WebDevelopmentTools() {
    ...
    const handleExploreToolsClick = () => {
        showSuccessToast('Explore Tools clicked');
    };
    const handleDiscoverMoreTools = () => {
        showSuccessToast('Discover more web tools');
    };
    ...
    return (
        ...
        >
            ...
            <Box sx={ { textAlign: 'center', marginBottom: 4, backgroundColor: 'var(--color-p4)', padding: 2 } }>
                ...
                <CustomButton onClick={ handleExploreToolsClick } text={ 'Explore Tools' } marginTop={ '1%' } />
            </Box>
            ...
            <Box sx={ { textAlign: 'center', marginTop: 6 } }>
                <CustomButton onClick={ handleDiscoverMoreTools } text={ 'Discover More Web Tools' } />
            </Box>
        </Box>
    );
}
