...
function BackendDeveloper() {
    ...
    const handleApplyNowClick = () => {
        showSuccessToast('Applying for Backend Developer position');
    };

    const handleLearnMoreCloudInfrastructureClick = () => {
        showSuccessToast('Learn more about Cloud Infrastructure and design principles');
    };
    const handleLearnMoreDatabaseManagementClick = () => {
        showSuccessToast('Learn more about Database Management and design principles');
    };
    const handleExploreBackendDeveloperOpportunitiesClick = () => {
        showSuccessToast('Exploring Backend Developer opportunities');
    };
    ...
    return (
        ...
        >
                ...
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ handleLearnMoreCloudInfrastructureClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ handleLearnMoreDatabaseManagementClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
            ...
            <Box sx={ { textAlign: 'center', marginTop: 6 } }>
                <CustomButton onClick={ handleExploreBackendDeveloperOpportunitiesClick } text={ 'Explore Backend Developer Opportunities' } />
            </Box>
        </Box>
    );
}
