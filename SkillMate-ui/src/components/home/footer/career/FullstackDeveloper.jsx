...
function FullstackDeveloper() {
    ...
    const handleApplyNowClick = () => {
        showSuccessToast('Applying for Full Stack Developer position');
    };
    const handleLearnMoreDevelopmentBestPracticesClick = () => {
        showSuccessToast('Learn more Development best practices');
    };
    const handleLearnMoreTechnologyToolsClick = () => {
        showSuccessToast('Learn more about Technology and tools used in Full Stack development');
    };
    const handleExploreFullStackDeveloperOpportunitiesClick = () => {
        showSuccessToast('Exploring Full stack Developer opportunities');
    };
    ...
    return (
        ...
        >
                ...
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ handleLearnMoreDevelopmentBestPracticesClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item xs={ 12 } md={ 6 }>
                    <Card sx={ { display: 'flex', flexDirection: 'column', height: '100%' } }>
                        ...
                        <CardContent>
                            ...
                            <CustomButton onClick={ handleLearnMoreTechnologyToolsClick } text={ 'Learn More' } />
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
            ...
            <Box sx={ { textAlign: 'center', marginTop: 6 } }>
                <CustomButton onClick={ handleExploreFullStackDeveloperOpportunitiesClick } text={ 'Explore Full Stack Developer Opportunities' } />
            </Box>
        </Box>
    );
}
