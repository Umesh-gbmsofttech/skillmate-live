...
function TrainerProfile() {
    ...
    const { courses, loading: coursesLoading } = useSelector((state) => state.trainerCourses);
    const { batches, batchIds, loading: batchesLoading } = useSelector((state) => state.trainerBatches);
    ...
    return (
        <>
            ...
            {/* Upcomming meetings */}
            <MyMeetings trainerId={userData.id} courses={courses} />
