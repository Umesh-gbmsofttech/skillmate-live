...
const TrainerSignUp = () => {
   ...
   // const {setUserData } =useContext(GlobalContext);
    ...
    const handleInputChange = (e) => {
        ...
        if (fullName === '') setFullName(value);
        if (fullName === 'mobileNumber') setMobileNumber(value);
        if (fullName === 'email') setEmail(value);
        if (fullName === 'address') setAddress(value);
        if (fullName === 'qualification') setQualification(value);
        if (fullName === 'experience') setExperience(value);
        if (fullName === 'workingStatus') setWorkingStatus(value);
    };
