...
const urls = {
    login: {
        sendOtpNumber: `http://localhost:8080/auth/otp/mobile`,
        sendOtpEmail: `http://localhost:8080/auth/otp/email`,
        verifyOtpNumber: `http://localhost:8080/auth/verifyOtp`,
        verifyOtpEmail: `http://localhost:8080/auth/verifyOtp`,
        // verifyOtpNumber: `http://localhost:8080/auth/verifyOtp/mobile`,
        // verifyOtpEmail: `http://localhost:8080/auth/verifyOtp/email`,
        getDetails: `http://localhost:8080/users/getdetails`,
    },
    admin: {
    ...
    course: {
        save: `http://localhost:8080/courses/create`,
        get: `http://localhost:8080/courses/fetch`,
        getid: (id) => `http://localhost:8080/courses/fetch/${id}`,
